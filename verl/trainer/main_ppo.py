...
class TaskRunner:
    ...
    def run(self, config):
        ...
        from verl.workers.reward_manager import AccRewardManager
        from verl.workers.reward_manager import LengthyRewardManager
        # 加载长度奖励处理类
        reward_fn = LengthyRewardManager(tokenizer=tokenizer,
                                        length_penalty_config=config.length_penalty)

        val_reward_fn = AccRewardManager(tokenizer=tokenizer)
